...
//                new Point3D(20000, -20000, -2000));
    ...
    public void testPart3_01(){
        ...
        Sphere sphere = new Sphere(new Color(0, 0, 100),
                170,0.1,0.5,0.2,0.2,80,
                new Point3D(0, 0, -200));
        scene.addGeometry(sphere);

        Triangle triangle = new Triangle(new Color(0, 50, 0),19,0,0.5,0.2,0.2,
    ...
    public void testBalls(){
        ...
        Sphere sphere = new Sphere(new Color(10, 100, 20),100, 0.1, 0.6,0.3,0,50, pSphere);
        //sphere.setEmmission(new Color(10, 100, 20));
        //sphere.setMaterial(material);
        scene.addGeometry(sphere);

        Point3D pSphere1 = new Point3D(-30, 0, -250);
        Sphere sphere1 = new Sphere(new Color(110, 20, 10), 100, 0.1, 0.4,0.3,0,70,pSphere1);
        //sphere1.setEmmission(new Color(110, 20, 10));
        //sphere1.setMaterial(material);
        scene.addGeometry(sphere1);

        Point3D pSphere2 = new Point3D(-10, 150, -350);
        Sphere sphere2 = new Sphere(new Color(20, 20, 100), 100, 0.2,0.8,0.2, 0.1,90,pSphere2 );
    ...
    public void myTest() {
        ...
        Render render = new Render(scene,imageWriter);
        Camera ca = new Camera(new Point3D(0,0,1000),new Vector(0,-1,0), new Vector(0,0,-1));
        scene.setCamera(ca);
