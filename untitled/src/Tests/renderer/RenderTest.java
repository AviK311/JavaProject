...
public class RenderTest {
    ...
    public void basicRendering() {
        ...
        Triangle triangle = new Triangle(red, 1, 0.5, 0.5, 0, 0, new Point3D(100, 0, -50),
                new Point3D(0, 100, -50),
                new Point3D(100, 100, -50));

        Triangle triangle2 = new Triangle(green, 1, 0.5, 0.5, 0, 0, new Point3D(100, 0, -50),
                new Point3D(0, -100, -50),
                new Point3D(100, -100, -50));

        Triangle triangle3 = new Triangle(orange, 1, 0.5, 0.5, 0, 0, new Point3D(-100, 0, -50),
                new Point3D(0, 100, -50),
                new Point3D(-100, 100, -50));

        Triangle triangle4 = new Triangle(pink, 1, 0.5, 0.5, 0, 0, new Point3D(-100, 0, -50),
                new Point3D(0, -100, -50),
                new Point3D(-100, -100, -50));
        Triangle triangle5 = new Triangle(green, 1, 0.5, 0.5, 0, 0, new Point3D(-100, 0, -50),
                new Point3D(0, 0, -50),
                new Point3D(-100, -100, -50));
    ...
    public void ball() {
        ...
        scene.addGeometry(new Sphere(blue, 1, 0.5, 0.5, 0, 0, 105, new Point3D(0.0, 0.0, -110)));

        //SpotLight light1 = new SpotLight(new Color(i,i,i), new Point3D(0,100,0), 0.5, 0.5,0.5,new Vector(0,-1,-1) );
        //DirectionalLight light1 = new DirectionalLight(new Color(i, i, i), new Vector(-1, 0, -1));
        //scene.getLights().add(light1);
        PointLight p2 = new PointLight(new Color(1, 1, 1), new Point3D(-30, 0, 0), 0.001, 0);
        DirectionalLight p3 = new DirectionalLight(new Color(50, 50, 50), new Vector(-1, 0, -1));
        for (int i = -10; i < 10; i++) {
            SpotLight p4 = new SpotLight(new Color(1, 1, 1), new Point3D(0, 0, 10), 0.01, 0, new Vector(0, i, -1));
            PointLight p1 = new PointLight(new Color(1, 1, 1), new Point3D(30, 0, 0), 0.001, 0);
    ...
    public void basicRendering2() {
        ...
        scene.addGeometry(new Sphere(blue, 2, 0.5, 0.2, 0, 0, 140, new Point3D(0, 0.0, -150)));
        // scene.addGeometry(new Sphere(blue, 3,0.5,0.2, 70, new Point3D(-20.0, 0.0, -150)));

        Triangle triangle = new Triangle(red, 3, 0.3, 0.6, 0, 0, new Point3D(100, 0, -50),
                new Point3D(0, 100, -50),
                new Point3D(100, 100, -50));

        Triangle triangle2 = new Triangle(green, 2, 0.7, 0.6, 0, 0, new Point3D(100, 0, -50),
                new Point3D(0, -100, -50),
                new Point3D(100, -100, -50));

        Triangle triangle3 = new Triangle(orange, 5, 0.3, 0.9, 0, 0, new Point3D(-100, 0, -50),
                new Point3D(0, 100, -50),
                new Point3D(-100, 100, -50));

        Triangle triangle4 = new Triangle(pink, 3, 0.3, 0.6, 0, 0, new Point3D(-100, 0, -50),
                new Point3D(0, -100, -50),
                new Point3D(-100, -100, -50));
        ...
        PointLight light2 = new PointLight(new Color(100, 100, 100), new Point3D(150, 0, -150), 0.3, 0.2);
        scene.getLights().add(light2);
        SpotLight light3 = new SpotLight(new Color(200, 100, 20), new Point3D(0, 0, 0), 0.9, 0.4, new Vector(new Point3D(0, 0, -1)));
...
//                new Point3D(-20000, 20000, -2000),
//                new Point3D(20000, -20000, -2000));
        Plane plane = new Plane(Color.BLACK, 1, 0.005, 0.1, 0, 0,
                new Point3D(-20000, -20000, -2000),
                new Point3D(-20000, 20000, -2000),
                new Point3D(20000, -20000, -2000));
        Triangle triangle2 = new Triangle(Color.BLACK, 1, 0.01, 0.5, 0, 0,
                new Point3D(2000, -2000, -1000),
                new Point3D(-2000, -2000, -1000),
                new Point3D(-2000, 2000, -1000));
        Sphere sphere = new Sphere(Color.BLACK, 1, 0.01, 0.5, 0, 0,
        ...
        PointLight light1 = new PointLight(new Color(1, 1, 1), new Point3D(0, 0, -1), 0, 0);
    ...
    public void testPart3_01() {
        ...
        Sphere sphere = new Sphere(new Color(0, 0, 100), 170, 0.1, 0.5, 0.2, 0.2, 80, new Point3D(0, 0, -250));
        scene.addGeometry(sphere);

        Triangle triangle = new Triangle(new Color(0, 50, 0), 19, 0, 0.5, 0.2, 0.2, new Point3D(0, 0, -450), //green triangle
                new Point3D(-2000, 0, -500),
                new Point3D(0, -4000, -500));
        scene.addGeometry(triangle);

        Triangle triangle1 = new Triangle(new Color(80, 0, 0), 19, 0, 0.5, 0.2, 0.2, new Point3D(100, 100, -100), //red triangle
                new Point3D(90, 200, -90),
                new Point3D(-50, 100, -100));
        scene.addGeometry(triangle1);

        Triangle triangle2 = new Triangle(new Color(33, 33, 33), 19, 0, 0.5, 0.2, 0.2, new Point3D(-2000, -2000, -2000), //gray triangle
    ...
    public void testBalls() {
        ...
        Sphere sphere = new Sphere(new Color(10, 100, 20), 20, 0, 1, 0, 0, 50, pSphere);
        //sphere.setEmmission(new Color(10, 100, 20));
        //sphere.setMaterial(material);
        scene.addGeometry(sphere);

        Point3D pSphere1 = new Point3D(-30, 0, -250);
        Sphere sphere1 = new Sphere(new Color(110, 20, 10), 20, 0, 1, 0, 0, 70, pSphere1);
        //sphere1.setEmmission(new Color(110, 20, 10));
        //sphere1.setMaterial(material);
        scene.addGeometry(sphere1);

        Point3D pSphere2 = new Point3D(-10, 150, -350);
        Sphere sphere2 = new Sphere(new Color(20, 20, 100), 20, 0, 0.1, 0.1, 1, 90, pSphere2);
        //sphere2.setEmmission(new Color(20, 20, 100));
        //sphere2.setMaterial(material);
        scene.addGeometry(sphere2);


        Plane plane = new Plane(new Color(133, 133, 133), 20, 0.01, 1, 0, 0, new Point3D(-100, 0, 0), new Vector(1, 0, 0));
        ...
        scene.addLight(new SpotLight(new Color(50, 10, 0), new Point3D(150, 150, -40), //right light
                0.00001, 0.000005, pSphere.subtract(new Point3D(300, 0, -250))));
        scene.addLight(new SpotLight(new Color(50, 10, 0), new Point3D(150, 150, -50), //right light
                0.00001, 0.000005, pSphere1.subtract(new Point3D(300, 0, -250))));
        scene.addLight(new SpotLight(new Color(50, 10, 0), new Point3D(150, 150, -60), //right light
                0.00001, 0.000005, pSphere2.subtract(new Point3D(300, 0, -250))));
    ...
    public void test() {
        ...
        Sphere sphere = new Sphere(new Color(0, 0, 100), 20, 1, 1, 0, 0, 800, new Point3D(0.0, 0.0, -1000));
        //Material m=new Material();
        //m.set_n(20);

        //sphere.setMaterial(m);
        scene.addGeometry(sphere);
        scene.addLight(new PointLight(new Color(255, 100, 100), new Point3D(-200, 200, 100), 0.00001, 0.000005));
    ...
    public void test2() {
        ...
        Triangle triangle = new Triangle(new Color(200, 0, 0), 20, 1, 1, 0, 0, new Point3D(-1000, -1000, -1000),
                new Point3D(-1000, -2000, -1000),
                new Point3D(2000, -1500, -1200));

        Triangle triangle2 = new Triangle(new Color(200, 0, 0), 20, 1, 1, 0, 0, new Point3D(-1000, -1000, -1000),
                new Point3D(-600, -700, -1500),
                new Point3D(2000, -1500, -1200));
        Sphere sphere = new Sphere(new Color(0, 0, 100), 20, 1, 1, 0, 0, 700, new Point3D(100, 100, -1200));
        ...
        scene.addLight(new PointLight(new Color(50, 50, 50), new Point3D(300, 300, -0), 0.0000001, 0.00000005));
