...
public class Pyramid extends Geometry {
    ...
    public Pyramid(Color emmision, int Shininess, double Kd, double Ks,double Kr, double Kt, Point3D p1, Point3D p2, Point3D p3,
        ...
        Triangle triangle1=new Triangle(emmision, Shininess, Kd, Ks,Kr, Kt,p1,p2,p3);
        Triangle triangle2=new Triangle(emmision, Shininess, Kd, Ks,Kr, Kt,p1,p2,p4);
        Triangle triangle3=new Triangle(emmision.add(new Color(20,0,0)), Shininess, Kd, Ks,Kr, Kt,p1,p2,p5);
        Triangle triangle4=new Triangle(emmision.scale(0.9), Shininess, Kd, Ks,Kr, Kt,p2,p3,p5);
        Triangle triangle5=new Triangle(emmision.scale(1.7), Shininess, Kd, Ks,Kr, Kt,p4,p3,p5);
        Triangle triangle6=new Triangle(emmision.scale(1.2), Shininess, Kd, Ks,Kr, Kt,p1,p4,p5);
